      ...
      <nav className= {`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className={`form-check form-switch mx-2 text-${props.mode==='dark' /*|| 'blue'*/ ? 'light': 'dark'}`}>
              <input className="form-check-input" onClick={props.toggleMode1} type="checkbox" role="switch" id="flexSwitchCheckDefault" />
              <label className="form-check-label" htmlFor="flexSwitchCheckDefault" color={props.mode=== /*'blue'||*/'dark'? 'white':'black'}>Enable Dark Mode</label>
            </div>
            {/* <div className={`form-check form-switch mx-2 text-${props.mode==='dark' || 'blue' ? 'light': 'dark'}`}>
